...
/**
 * Data access exception to be used when communication with the database is impossible.
 */
public class DataAccessFailureException extends DataAccessException {
