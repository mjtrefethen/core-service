...
CREATE TABLE `cd_region` (
  ...
  `name` nvarchar(255) NOT NULL COMMENT 'ISO3166-1 Short name\nor\nISO3166-2 Subdivision name',
  `name_lc` nvarchar(255) DEFAULT NULL COMMENT 'ISO3166 Short name lower case',
  `name_full` nvarchar(255) DEFAULT NULL COMMENT 'ISO3166 Full name',
  `name_common` nvarchar(255) DEFAULT NULL COMMENT 'Based on ISO3166-1 Short name lower case or ISO3166-2 Subdivision name. Data modified to remove parenthesis, brackets and massage naming to better meet common country representations.',
  `code_alpha` nvarchar(10) DEFAULT NULL COMMENT 'ISO 3166-1 alpha-2 code \nor\nISO 3166-2 code',
  `code_alpha_alt` nvarchar(10) DEFAULT NULL COMMENT 'ISO 3166-1 alpha-3 code',
  `code_numeric` nvarchar(10) DEFAULT NULL COMMENT 'ISO 3166-1 numeric code',
